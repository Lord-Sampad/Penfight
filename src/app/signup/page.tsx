      ...
      <div className="max-w-md w-full bg-white dark:bg-gray-900 p-4 md:p-4 md:p-6 lg:p-8 shadow-2xl border-4 border-gray-900 dark:border-gray-100 rounded-sm relative z-10">
        ...
        <form className="flex flex-col gap-4 md:p-6">
          ...
          <div className="flex flex-col gap-4 mt-2">
            <button 
              formAction={signup} 
              className="w-full bg-[#1a237e] hover:bg-blue-800 text-white font-bold py-3 px-4 rounded-sm shadow-md border-2 border-gray-900 dark:border-gray-100 transition-all uppercase tracking-wider"
            >
              Sign Up
            </button>
